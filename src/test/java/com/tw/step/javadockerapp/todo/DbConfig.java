...
public class DbConfig {
    ...
    public PostgresConfig postgresConfig() throws IOException {
        ...
        final PostgresConfig postgresConfig = new PostgresConfig(() -> "11.2.0",
                new AbstractPostgresConfig.Net("db",
                        Network.getFreeServerPort()),
                new AbstractPostgresConfig.Storage("test"),
                new AbstractPostgresConfig.Timeout(),
                new AbstractPostgresConfig.Credentials("postgres", "password")
        );
